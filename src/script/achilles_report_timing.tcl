report_timing -detail full_path -npaths 20 -setup -file achilles_timing_report.rpt
report_timing -detail full_path -npaths 20 -hold -append -file achilles_timing_report.rpt
report_timing -detail full_path -npaths 20 -recovery -append -file achilles_timing_report.rpt
report_timing -detail full_path -npaths 20 -removal -append -file achilles_timing_report.rpt
